...
const BLUE      = "#0054A6";
const BLUE_DARK = "#003C7A";   // CTA banner background — deep navy
const BLUE_TINT = "#7EB8FF";   // light accent for text on dark bg
  ...
  return (
    <>
      <style>{`
        ...
        /* Decorative circles — now use blue tints instead of sage */
        .cta-corner-1 {
        ...
        .cta-corner-2 {
          ...
          border: 1px solid rgba(126,184,255,.10);
        }
        .cta-corner-3 {
        ...
        .cta-eyebrow {
          ...
          color: ${BLUE_TINT}; margin-bottom: 20px;
          display: flex; align-items: center; justify-content: center; gap: 10px;
        }
        .cta-eyebrow::before,
        .cta-eyebrow::after {
          content: ''; display: block; width: 36px; height: 1px;
          background: rgba(126,184,255,.35);
        }
        ...
        .cta-h2 em { font-style: normal; color: ${BLUE_TINT}; }
        ...
        /* Primary: white on dark — high contrast CTA */
        .cta-btn-white {
        ...
        .cta-trust-item {
          ...
          color: rgba(255,255,255,.44); letter-spacing: .03em;
        }
        .cta-trust-check {
          width: 18px; height: 18px; border-radius: 50%;
          background: rgba(126,184,255,.15);
          border: 1px solid rgba(126,184,255,.30);
          display: flex; align-items: center; justify-content: center;
          font-size: 9px; color: ${BLUE_TINT}; flex-shrink: 0;
        }
